...
UPDATE  UserAccount SET HOTEN='HỘI',TUOI=19,CMND=206441011,SDT='0829124999',EMAIL='lesyhoi0120@gmail.com' WHERE TENDN='lesyhoi' 

SELECT TOP 12 MONTH(NGAYTRA) 'THANG',YEAR(NGAYTRA) 'NAM',SUM(SOLUONG) 'SOLUONGS'
FROM Borrow
WHERE NGAYTRA<'20/12/2021'
